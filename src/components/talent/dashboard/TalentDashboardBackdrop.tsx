...
/**
 * Ambient SVG backdrop for the talent dashboard overview page.
 *
 * Mirrors the company DashboardBackdrop with talent-specific organic shapes.
 * Uses the Veloraa palette: dark green, mid green, bright green, beige.
 * All shapes are `pointer-events-none` and sit behind dashboard content.
 */
export default function TalentDashboardBackdrop({
  className,
}: {
  className?: string;
}) {
  return (
    ...
    >
      ...
      >
        ...
        <rect width="100%" height="100%" fill="url(#talent-bg-dots)" />
      </svg>

      {/* Layer 2 — top-right organic blade (bright green) */}
      ...
      {/* Layer 3 — small disc, top-center-right */}
      <div className="velora-pulse-soft absolute right-[18%] top-[10%] h-16 w-16 sm:h-20 sm:w-20">
        <svg
          ...
          className="h-full w-full"
        >
          <circle cx="40" cy="40" r="36" fill="#B8B09A" fillOpacity="0.18" />
          <circle
            cx="40"
            cy="40"
            r="36"
            ...
            fill="none"
          />
          <circle cx="40" cy="40" r="22" fill="#16A34A" fillOpacity="0.10" />
        </svg>
      </div>

      {/* Layer 4 — left-side dark blade */}
      ...
      {/* Layer 6 — bottom-right overlapping shapes */}
      <div className="velora-drift-y absolute -bottom-[5%] -right-[8%] h-[42vw] w-[55vw] max-h-[480px] max-w-[680px]">
        ...
        >
          ...
          <path
            ...
            fillOpacity="0.14"
          />
          <circle cx="540" cy="260" r="34" fill="#4ADE80" fillOpacity="0.25" />
          <circle
            cx="540"
            cy="260"
            r="34"
      ...
      {/* Layer 7 — sweeping arcs across mid-page */}
      <svg
      ...
      {/* Layer 8 — small beige triangle, bottom-left */}
      <div className="velora-pulse-soft absolute bottom-[12%] left-[6%] hidden h-16 w-16 lg:block">
        <svg
          ...
          className="h-full w-full"
        >
          <path d="M 8 56 L 56 56 L 32 12 Z" fill="#B8B09A" fillOpacity="0.25" />
          <path
